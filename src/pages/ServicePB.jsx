  ...
  return (
    <main className="pt-[82px] bg-[#f7f9fc] text-[#191c1e] min-h-screen">
      ...
      <section className="max-w-[1440px] mx-auto px-6 md:px-10 lg:px-16 grid grid-cols-12 gap-8 items-stretch mt-10 md:mt-16 mb-12 md:mb-24">
        <div className="col-span-12 lg:col-span-8 flex flex-col justify-center">
          <h1 className="font-headline font-extrabold leading-[1.1] tracking-tighter text-[#0a192f] mb-8">
            <span className="block text-[#0a192f] whitespace-nowrap">Preserve your identity.</span>
      ...
      <section className="bg-white py-16 md:py-24">
        <div className="max-w-[1440px] mx-auto px-6 md:px-10 lg:px-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div className="md:col-span-2 bg-[#f2f4f7] rounded-xl p-10 lg:p-12 flex flex-col justify-between min-h-[360px]">
              <div>
            ...
            <div className="md:col-span-2 bg-[#0a192f] rounded-xl p-10 lg:p-12 flex flex-col justify-between relative overflow-hidden min-h-[220px]">
              <div className="relative z-10">
      ...
      <section className="bg-white py-10 md:py-14">
        <div className="max-w-[1440px] mx-auto px-6 md:px-10 lg:px-16 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 md:gap-12">
