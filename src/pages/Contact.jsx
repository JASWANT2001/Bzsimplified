  ...
  return (
    <div className="flex flex-col items-start gap-7 py-4">
      ...
      <div>
        ...
        <p className="font-body text-slate-500 text-[15px] leading-[1.7] max-w-sm">
      ...
      <div className="space-y-3 w-full max-w-xs pt-2">
        <button onClick={onReset} className="w-full inline-flex items-center justify-center gap-2 px-5 py-2.5 border border-slate-200 text-[#0a192f] font-body font-semibold text-[14px] rounded-lg hover:bg-slate-50 transition-all duration-200">
          Send another message
        </button>
        <Link to="/" className="w-full inline-flex items-center justify-center gap-2 px-5 py-2.5 bg-[#0a192f] text-white font-body font-semibold text-[14px] rounded-lg transition-all duration-200 hover:shadow-[0_6px_20px_rgba(10,25,47,0.18)]">
          Back to Home
        </Link>
      </div>
    </div>
