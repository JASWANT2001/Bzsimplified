    ...
    <main className="pt-[82px] bg-[#f7f9fc] text-[#191c1e] min-h-screen">
      ...
      <section className="max-w-[1440px] mx-auto px-6 md:px-10 lg:px-16 grid grid-cols-12 gap-8 items-stretch mt-10 md:mt-16 mb-12 md:mb-24">
        <div className="col-span-12 lg:col-span-7 flex flex-col justify-center">
          ...
          <p className="font-body text-base md:text-fs-lead text-[#5a5e6a] max-w-2xl leading-relaxed">
      ...
      <div className="max-w-[1440px] mx-auto px-6 md:px-10 lg:px-16">
        <h2
          className="font-headline font-extrabold text-[#0a192f] tracking-tighter mb-10 text-2xl sm:text-3xl md:text-4xl"
        >
        ...
        <div className="grid grid-cols-12 gap-4">
          ...
          <div className="col-span-12 md:col-span-7 bg-[#0a192f] rounded-xl p-7 md:p-10 lg:p-12 flex flex-col justify-between relative overflow-hidden min-h-[260px] md:min-h-[300px] transition-all duration-300 hover:-translate-y-1 hover:shadow-[0_12px_48px_rgba(10,25,47,0.35)]">
            <div className="relative z-10">
              ...
              <h3 className="font-headline text-white text-xl sm:text-2xl lg:text-4xl font-bold mb-6">
                Business Strategy
              </h3>
          ...
          <div className="col-span-12 md:col-span-8 bg-[#f2f4f7] rounded-xl p-6 md:p-10 lg:p-12 flex flex-col sm:flex-row sm:items-start gap-8 transition-all duration-300 hover:-translate-y-1 hover:shadow-md hover:bg-[#e8ebf0]">
            ...
            <div className="sm:border-l sm:border-slate-300 sm:pl-8 flex flex-col items-start sm:items-end text-left sm:text-right shrink-0">
              <div className="font-headline font-extrabold leading-none text-[#0a192f] text-2xl md:text-3xl">14d</div>
      ...
      <section className="bg-[#eceef1] py-10 md:py-14">
        ...
        <div className="max-w-[1440px] mx-auto px-6 md:px-10 lg:px-16 grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-16">
          <div className="border-l-4 border-[#0a192f] pl-8 pb-6 border-b border-slate-200 last:border-b-0 md:border-b-0 md:pb-0">
            <div className="font-headline font-extrabold text-[#0a192f] mb-2 text-3xl md:text-4xl">30+</div>
          ...
          <div className="border-l-4 border-[#e31e24] pl-8 pb-6 border-b border-slate-200 last:border-b-0 md:border-b-0 md:pb-0">
            <div className="font-headline font-extrabold text-[#0a192f] mb-2 text-3xl md:text-4xl">14 Days</div>
