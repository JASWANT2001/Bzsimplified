          ...
          <div className="flex flex-col gap-7">
            ...
            <div>
              ...
              <div className="flex items-center gap-2">
                ...
                {/* Instagram */}
                <a href="https://www.instagram.com/bzsimplified/" target="_blank" rel="noreferrer" title="Instagram" className="w-8 h-8 rounded-lg bg-white/8 hover:bg-[#e1306c]/20 border border-white/10 flex items-center justify-center transition-colors duration-200 group">
